...
// restoreCheckpoint reads a saved geometry JSON and replays all accepted
// shapes onto the evaluator canvas, returning the restored shape list and
// the count of non-background shapes that were successfully replayed.
func restoreCheckpoint(path string, prepared *imageutil.PreparedImage, forceOpaque bool, evaluator *gpu.Evaluator) ([]model.Shape, int, error) {
